...
#define BALANCE_KP 22                  // PID Constants
#define BALANCE_KI 200                 // Constants changed as per device
#define BALANCE_KD 1.15
#define BALANCE_PID_MIN -255              // Define PID limits to match PWM max in reverse and forward
#define BALANCE_PID_MAX 255

#define ROTATION_KP 133
#define ROTATION_KI 800
#define ROTATION_KD 8
...
float MOTORSLACK_B=32;          //Original slack was 39 on B. It changes as per device           // Compensate for motor slack range (low PWM values which result in no motor engagement)
